...
|
*/
$config['encryption_key'] = 'K3yS5355i0n';
...
$config['sess_cookie_name'] = 'TCMSess';
$config['sess_expiration'] = 3600;
$config['sess_save_path'] = 'TCM_SESSIONS';
...
$config['csrf_token_name'] = 'mgj_token';
$config['csrf_cookie_name'] = 'mgj_cookie';
...
//con excepciones para librerias
...
//print "$class <br/>";
	...
	$full_except = array();
	foreach ($except as $one) {
		$full_except[] = "CI_" . $one;
		$full_except[] = "My_" . $one;
	}

	if (!in_array($class, $full_except)) {
		if(strpos($class, 'CI_') !== 0) {
			if(file_exists(APPPATH . 'core/'. $class . '.php')){
				include_once( APPPATH . 'core/'. $class . '.php' );					
			}

			if(file_exists(APPPATH . 'abstract_class/'. $class . '.php')){
